    ...
    <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-md py-3' : 'bg-transparent py-5'}`}>
      ...
      <div className={`absolute top-full left-0 w-full bg-white shadow-xl py-6 flex flex-col items-center gap-4 md:hidden border-t transform transition-transform duration-300 ${isOpen ? 'translate-y-0' : '-translate-y-full opacity-0'}`}>
        ...
        <div className="pt-2 w-full px-6">
            <a href="https://wa.me/628123456789" className="w-full flex justify-center items-center gap-2 bg-red-600 text-white py-3 rounded-lg font-bold">
      ...
      <div className="container mx-auto px-4 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-white space-y-6 animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            ...
            <a href="#contact" className="bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 text-white px-8 py-4 rounded-xl font-bold transition-all flex items-center justify-center">
              Hubungi Kami
            </a>
          </div>
        </div>
          ...
          {carFleet.map((car) => (
            <div key={car.id} className="bg-white rounded-2xl shadow-sm hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-300 group overflow-hidden border border-slate-100 flex flex-col">
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                {car.available ? (
                    <a 
                    href={`https://wa.me/628123456789?text=Halo%20Arya%20Rent,%20saya%20tertarik%20sewa%20${car.name}%20untuk%20tanggal...`}
                    target="_blank"
                    rel="noreferrer"
        ...
        <section className="py-20 bg-red-600 text-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 text-center relative z-10">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="https://wa.me/628123456789" className="bg-white text-red-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-slate-100 transition-colors shadow-xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#contact" className="hover:text-red-500 transition-colors">Hubungi Kami</a></li>
            </ul>
          </div>
